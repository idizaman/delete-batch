...
<script type="text/javascript">	
	...
	function formCheck()
   {
	...
	if (window.document.frmqfeedback.answer.value == "-1" )
	{
...
<body>
<form name="frmqfeedback" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onSubmit="var x= formCheck();return x;">
<!--form name="frmqfeedback" method="post" action="feedback_question.php" onSubmit="var x= formCheck();return x;"-->
...
?>	
  ...
  <table width="746" border="1" align="center" cellspacing="2" bordercolor="#55A0FF" bgcolor="#FFFFFF" >
    ...
    <td colspan="3"><input name="examdate" type="text" size="10" value="<?php if(isset($_POST['examdate'])){echo $_POST['examdate'];} ?>"/><img src="./images/cal.gif" alt="Pick a Date"  style="cursor:pointer;cursor:hand;" onClick="popUpCalendar(this, document.frmqfeedback.examdate,'yyyy-mm-dd');return false;" ></td>
